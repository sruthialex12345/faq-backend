...
// // Dynamically fetch active collections
...
//   const config = activeCollections.find((c) => c.name === plan.collection);
...
//       try {
//         // Fetch dynamic collections from plugin
...
//     let newKey = key;
//     // Add $ prefix if it's a known operator missing it
...
//   const result = await strapi.entityService.findMany(uid, {
//     filters: sanitizedFilters, // Use the fixed filters
//     sort: plan.sort,
//     limit: 10,
//   });
